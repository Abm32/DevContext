...
// ─── Repo slot colors (up to 10 repos) ───────────────────────────────────────
export const REPO_COLORS = [
  ...
  { bg: "bg-amber-500/15", border: "border-amber-500/30", text: "text-amber-300", dot: "bg-amber-400", label: "amber" },
  { bg: "bg-rose-500/15", border: "border-rose-500/30", text: "text-rose-300", dot: "bg-rose-400", label: "rose" },
  { bg: "bg-pink-500/15", border: "border-pink-500/30", text: "text-pink-300", dot: "bg-pink-400", label: "pink" },
  { bg: "bg-cyan-500/15", border: "border-cyan-500/30", text: "text-cyan-300", dot: "bg-cyan-400", label: "cyan" },
  { bg: "bg-lime-500/15", border: "border-lime-500/30", text: "text-lime-300", dot: "bg-lime-400", label: "lime" },
  { bg: "bg-orange-500/15", border: "border-orange-500/30", text: "text-orange-300", dot: "bg-orange-400", label: "orange" },
  { bg: "bg-teal-500/15", border: "border-teal-500/30", text: "text-teal-300", dot: "bg-teal-400", label: "teal" },
] as const
