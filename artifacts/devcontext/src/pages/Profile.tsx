...
const TIER_CONFIG: Record<PlanTier, {
  ...
  team: {
    label: "Team Plan",
    price: "₹2,499",
    description: "2,000 AI analyses/month · Compare up to 10 repos · Up to 10 members",
    color: "#34d399",
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: "#475569" }}>
                  You have maximum access with 2,000 AI analyses/month, compare up to 10 repos, and up to 10 team members.
                </p>
              </div>
            </div>
          )}
