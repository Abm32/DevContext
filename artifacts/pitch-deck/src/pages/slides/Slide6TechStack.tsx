          ...
          <div className="flex-1 space-y-[2vh]">
            <div className="flex items-center gap-[1.5vw] p-[2vh_2vw] rounded-[0.8vw] border border-white/8 bg-[#0f0f1e]">
              ...
              <div>
                ...
                <p className="font-body text-[1.2vw] text-white/45">Repos, commits, diffs — real developer data</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-[1.5vw] p-[2vh_2vw] rounded-[0.8vw] border border-white/8 bg-[#0f0f1e]">
              ...
              <div>
                ...
                <p className="font-body text-[1.2vw] text-white/45">Context synthesis — no API key required</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-[1.5vw] p-[2vh_2vw] rounded-[0.8vw] border border-white/8 bg-[#0f0f1e]">
              ...
              <div>
                <p className="font-display text-[1.4vw] font-semibold text-white">React + Express 5</p>
                <p className="font-body text-[1.2vw] text-white/45">Full-stack TypeScript — JWT auth, REST API</p>
              </div>
            </div>
          </div>

          <div className="w-[28vw] p-[3vh_2.5vw] rounded-[1vw] border border-[#10b981]/20 bg-[#10b981]/5">
            <p className="font-body text-[1.2vw] font-medium tracking-[0.15em] uppercase text-[#10b981] mb-[2vh]">Why It Matters</p>
            <div className="space-y-[1.5vh]">
              <div className="flex items-start gap-[0.8vw]">
                <div className="mt-[0.5vh] w-[0.4vw] h-[0.4vw] rounded-full bg-[#10b981] shrink-0" />
                <p className="font-body text-[1.3vw] text-white/65 leading-snug">Zero configuration — just OAuth</p>
              </div>
              <div className="flex items-start gap-[0.8vw]">
                <div className="mt-[0.5vh] w-[0.4vw] h-[0.4vw] rounded-full bg-[#10b981] shrink-0" />
                <p className="font-body text-[1.3vw] text-white/65 leading-snug">Stateless JWT auth — scales to any number of users</p>
              </div>
              <div className="flex items-start gap-[0.8vw]">
                <div className="mt-[0.5vh] w-[0.4vw] h-[0.4vw] rounded-full bg-[#10b981] shrink-0" />
                <p className="font-body text-[1.3vw] text-white/65 leading-snug">Parallel API calls — results in under 10 seconds</p>
              </div>
              <div className="flex items-start gap-[0.8vw]">
                <div className="mt-[0.5vh] w-[0.4vw] h-[0.4vw] rounded-full bg-[#10b981] shrink-0" />
                <p className="font-body text-[1.3vw] text-white/65 leading-snug">Deployed and live on Replit</p>
              </div>
            </div>
          </div>
        </div>
